...
public class PlayerController : MonoBehaviour
{
    ...
    //Si un método solo tiene una sentencia de código, se puede poner como abajo
    //Método para parar al jugador
    public void StopPlayer() => _theRB.velocity = Vector2.zero; //Vector2.zero = new Vector2(0,0)
